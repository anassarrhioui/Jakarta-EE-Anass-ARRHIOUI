        ...
        return args -> {
            ...
            studentRepository.saveAll(
                    Arrays.asList(
                            ...
                            Student.builder().nom("Mohammed2").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            ...
                            Student.builder().nom("Mohammed4").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            Student.builder().nom("Mohammed5").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            Student.builder().nom("Mohammed6").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            Student.builder().nom("Mohammed7").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            Student.builder().nom("Mohammed8").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
                            Student.builder().nom("Mohammed9").prenom("Arrhioui").dateNaissance(new Date()).enRegle(false).genre(GenreEnum.M).email("Anass@gmail.com").build(),
